...
graphs as a basis for the networks introduced in this work, common
network measures are reviewed. Random graph models are integral to
this work and are discussed in Sections~\ref{sec:random_graph_theory}
and \ref{sec:geometric_graphs}, the latter introducing geometric
random graphs and performing geometric, probabilistic computations
essential for the analytical discussions in later chapters.
