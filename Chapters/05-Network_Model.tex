 ...
 \fcolorbox{black}{lightgray}{
   \begin{minipage}[c]{0.90\textwidth}
     ...
     \begin{wrapfigure}{r}{0.65\textwidth}
       ...
       \centering
       \includegraphics[width=\linewidth]{gfx/img/potential_synapse2.png}
       \vspace{-35pt}
       \caption{}
...
% {\includegraphics[width=0.6\textwidth]{gfx/img/potential_synapse1.png}}
% {%
...
\begin{figure}[!ht]
  \makebox[0.875\textwidth]{%
    \includegraphics[width=0.4\textwidth]{%
      gfx/img/network_model/p14rr_1_traced_soma_unit_A.pdf}%
    \hfill
   \begin{overpic}[width=0.4\textwidth]{gfx/img/network_model/p14rr_1_traced_soma.pdf}
...
\begin{figure}[!ht]
  \centering 
  \includegraphics[width=0.5\textwidth,frame]{gfx/img/network_model/neural_anisotropy.pdf}
  \caption{%
    \textbf{Connected neurons of single pyramidal cell align with axon
    projection} Combining simplified stereotypical axonal profiles (cf.
    \autoref{fig:axon_heat}, soma in center, black) and dendritic
    profiles (cf. \autoref{fig:dendrite_heat}), illustrates how
    connected neurons (red) tend to cluster around the pre-synaptic axon's
    profile, as spatial closeness constitutes a necessary condition for the
    formation of contacts. Unconnected neurons (gray) are found
    distant from the axon's projection, but not necessarily distant from the soma.
  }
...
%   \vspace{0.2cm}
%   \makebox[0.875\textwidth]{%
%     \begin{overpic}[width=0.4\textwidth]{gfx/img/network_model/p14rr_1-5_overlay.pdf}
%       \put(3,92){\small\textbf{A}}
%     \end{overpic}
%     \hfill
%     \begin{overpic}[width=0.4\textwidth]{gfx/img/network_model/axon_heat_correct_soma.png}
