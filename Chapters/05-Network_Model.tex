...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.8\linewidth]{/users/hoffmann/research/data/axon_width_computation/foo.pdf}
...
\begin{figure}[!htbp]
  \centering
  \includegraphics[width=0.8\linewidth]{/users/hoffmann/research/data/sample_graph_analysis/distance_profiles/original/test.pdf}
