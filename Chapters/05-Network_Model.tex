...
\section{Anisotropic geometric network model}\label{sec:anisotropic_network_model}
...
%Unit square, scale later

\begin{definition}[Anisotropic random graph model] is a random process
