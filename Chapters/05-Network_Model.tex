...
\begin{figure}[!ht]
  \centering 
  \makebox[0.875\textwidth]{%
    \begin{overpic}[width=0.4\textwidth,frame]{gfx/img/network_model/axon_dendrite_meet.pdf}
      \put(3,92){\small\textbf{A}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.4\textwidth,frame]{gfx/img/network_model/axon_dendrite_meet_schema_dense.pdf}
      \put(3,92){\small\textbf{B}}
    \end{overpic}
    }%
...
\begin{figure}[!htbp]
  \centering 
  \makebox{%
    \begin{overpic}[width=0.325\textwidth,frame]{gfx/img/network_model/model_dendrite.pdf}
      \put(3,91){\small\textbf{A}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.325\textwidth,frame]{gfx/img/network_model/model_axon.pdf}
      \put(3,91){\small\textbf{B}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.325\textwidth,frame]{gfx/img/network_model/connectivity.pdf}
...
Algorithm in Python, in connectivity stored in graph
