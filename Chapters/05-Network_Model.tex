...
\begin{figure}[!htbp]
  ...
  \makebox[0.875\textwidth]{%
    \begin{overpic}[width=0.4\textwidth]{%
        gfx/img/network_model/p14rr_1.pdf}
      \put(3,92){\small\textbf{A}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.4\textwidth]{%
        gfx/img/network_model/p14rr_1_axon_traced_soma.pdf}
...
\begin{figure}[!htbp]
  ...
  \makebox{%
    \begin{overpic}[width=0.325\textwidth,frame]{%
        gfx/img/network_model/model_dendrite.pdf}
      \put(3,91){\small\textbf{A}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.325\textwidth,frame]{%
        gfx/img/network_model/model_axon.pdf}
      \put(3,91){\small\textbf{B}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.325\textwidth,frame]{%
        gfx/img/network_model/connectivity.pdf}
