...
\begin{definition}[Anisotropic geometric graph]
  ...
  \index{anisotropic geometric!graph} Let $n \in \mathbb{N}$ and $w
  ...
  \]
  hold, where $R_{\varphi}$ is the rotation matrix of angle $\varphi$
...
\begin{theorem} \label{theorem:distance_prof} Let $(G,\Phi, a)$ represent an
...
\begin{figure}[h] 
  ...
  \caption{\textbf{Illustration of proof to
