...
Investigation \marginpar{
    \begin{center}
      \includegraphics[width=0.9\linewidth]{gfx/img/HCP_text_logo.png}
...
Research in brain connectivity spreads over the whole scale \marginpar{\begin{center}
    \includegraphics[width=1.\linewidth]{gfx/img/AllenBrainLogo.png}\end{center}\vspace{-0.3cm}\mbox{\textrm{\href{http://www.brain-map.org/}{brain-map.org}}}} of the
...
\parencite{Brette_Neural-activity}%?? Chapter3 - Intracellular Recordings
...
\begin{comment}
  \parbox{1.8cm}{Human Connectome
    Project}\includegraphics[width=0.45\linewidth]{gfx/img/HCP_logo.png}
  \mbox{\url{humanconnectome.org}}}
\end{comment}
