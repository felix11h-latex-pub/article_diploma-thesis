%************************************************
\chapter{Strucutral Aspects}\label{ch:Strucutral Aspects} % $\mathbb{ZNR}$
%************************************************
...
Investigation \marginpar{
    \begin{center}
      \includegraphics[width=0.9\linewidth]{gfx/HCP_text_logo.png}
...
Research in brain connectivity spreads over the whole scale \marginpar{\begin{center}
    \includegraphics[width=1.\linewidth]{gfx/AllenBrainLogo.png}\end{center}\vspace{-0.3cm}\mbox{\textrm{\href{http://www.brain-map.org/}{brain-map.org}}}} of the
...
\cite{Brette_Neural-activity}%?? Chapter3 - Intracellular Recordings
...
\begin{comment}
  \parbox{1.8cm}{Human Connectome
    Project}\includegraphics[width=0.45\linewidth]{gfx/HCP_logo.png}
  \mbox{\url{humanconnectome.org}}}
\end{comment}
...
extrapolate results found in the biological situation.
\end{comment}
