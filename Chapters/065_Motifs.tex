...
\begin{figure}[H]
  ...
  \caption{\textbf{Stronger overrepresentation of clusters with high
    ...
    edge counts is stronger (\smtcite{7c826e10}) }
...
Both for in- and out-neighbors we find characteristic . Here the
...
\begin{figure}[H]
  \centering
  \makebox{%
    \begin{overpic}[width=0.5\textwidth,frame]{%
        /users/hoffmann/research/5841710e_in_k_tanfitrew.pdf}
%plots/5841710e_in_k_tanfitrew.pdf}
      \put(21,56.6){\small\textbf{A}}
    \end{overpic}
    \hfill
    \begin{overpic}[width=0.5\textwidth,frame]{%
        %plots/temp/civ_test.pdf}
/users/hoffmann/research/civ_test.pdf}
      \put(21,56.6){\small\textbf{B}}
    \end{overpic}
  }%
  \captionsetup{skip=7pt}
  \caption{\textbf{Anisotropy increases variance of
      common input distribution} For a neuron pair 
    (\smtcite{something})}
  \label{fig:cm_rule}
\end{figure}
