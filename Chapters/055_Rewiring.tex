...
isotropic, fully rewired graphs. By introducing a measure for
anisotropy and applying it to the rewired and original version of the
sample graphs, we're able to solidify this notion and tie together the
concepts introduced through this chapter in the next section.

% (labels:\smtcite{N1000w\char`_ax126-flat\char`_graph0-25\-rewired\char`_frac025},
% \smtcite{-50},-75,-100)
