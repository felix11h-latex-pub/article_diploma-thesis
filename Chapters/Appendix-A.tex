...
\marginpar{Sumatra labels}\index{label} in the text, a label was
...
Further contributing to the reproducibility of this work
\marginpar{use of free, open source software} is the exclusive use of
